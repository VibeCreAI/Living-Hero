...
export class ObstacleSystem {
  ...
  init(scene: Scene, options: ObstacleInitOptions = {}): void {
    ...
    for (const obstacle of this.obstacles) {
      ...
      gfx.fillStyle(0x554433, 0.85);
      gfx.fillRoundedRect(obstacle.x, obstacle.y, obstacle.width, obstacle.height, 6);
      gfx.lineStyle(2, 0x776655, 0.7);
      gfx.strokeRoundedRect(obstacle.x, obstacle.y, obstacle.width, obstacle.height, 6);
      gfx.setDepth(1);
      ...
      const label = scene.add.text(
        ...
        obstacle.label,
        { fontSize: '9px', color: '#998877', fontFamily: 'monospace' }
      );
      label.setOrigin(0.5);
      label.setDepth(2);
